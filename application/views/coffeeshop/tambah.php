				...
				<div class="card-body">
					...
					<!-- <form action="" method="post"> -->
						...
						<div class="form-group">
							...
							<input type="text" name="nama_coffeeshop" class="form-control col-md-7" id="nama_coffeeshop">
						...
						<div class="form-group">
							...
							<input type="time" name="jam_buka" class="form-control" id="jam_buka"></input>
							<small  class="form-text text-danger"><?= form_error('jam_buka'); ?>.</small>
						</div>
						<!-- jamtutup -->
						<div class="form-group">
							<label for="jam_tutup">Jam Tutup</label>
							<input type="time" name="jam_tutup" class="form-control" id="jam_tutup"></input>
							<small  class="form-text text-danger"><?= form_error('jam_tutup'); ?>.</small>
						</div>
						<!-- fas -->
						<div class="form-group">
							<label for="fasilitas">Fasilitas</label>
							<textarea rows="9" type="fasilitas" name="fasilitas" class="form-control" id="fasilitas"></textarea>
						...
						<div class="form-group">
							...
							<input type="text" name="harga_menu_min" class="form-control col-md-7" id="harga_menu_min">
						...
						<div class="form-group">
							...
							<input type="text" name="harga_menu_max" class="form-control col-md-7" id="harga_menu_max">
						...
						<div class="form-group">
							...
							<input type="text" name="lattitude" class="form-control col-md-7" id="lattitude">
							<small  class="form-text text-danger"><?= form_error('lattitude'); ?>.</small>
						</div>
						<!-- long -->
						<div class="form-group">
							<label for="longitude">Longitude</label>
							<input type="text" name="longitude" class="form-control col-md-7" id="longitude">

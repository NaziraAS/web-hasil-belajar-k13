				...
				<div class="card-body">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="id_mapel" maxlength="10" class="form-control" id="id_mapel" value="<?= set_value('id_mapel'); ?>">
						...
						<div class="form-group">
							...
							<input type="text" name="nama_mapel" class="form-control" id="nama_mapel" value="<?= set_value('nama_mapel'); ?>">

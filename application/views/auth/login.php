    ...
    <div class="col-lg-7">
      ...
      <div class="card o-hidden border-0 shadow-lg my-3" style="background-image: url(<?= base_url(); ?>assets/img/spikes.png);">
        ...
        <div class="mt-4 text-center">
          <img class="rounded-circle" width="180px" height="180px" src="<?= base_url(); ?>assets/img/sma.jpg">
        </div>
            ...
            <div class="col-lg ">
              ...
              <div class="p-5">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4"><b>SMP NEGERI 3 SATU ATAP TALIABU BARAT</b><br>| Login |</h1>
                </div>
